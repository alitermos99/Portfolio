...
export default class PortfolioLink extends LightningElement {
	...
	get spanClassName() {
		...
		return `${this._currentPageName === href ? "w-full" : "w-0"} h-[1px] inline-block bg-dark absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300`;
	}
